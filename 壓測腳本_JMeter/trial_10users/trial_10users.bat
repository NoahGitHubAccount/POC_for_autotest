...
mkdir "%OUTDIR%" 2>nul
call "%JMETER_BIN%" -n -t "%SHARE%\loadtest_150.jmx" %JPROPS% -JTHREADS=10 -JRAMP=20 -JDURATION=120 -JTHINK_BROWSE=3000 -JTHINK_BROWSE_R=4000 -JTHINK_FORM=5000 -JTHINK_FORM_R=5000 -l "%OUTDIR%\result.jtl" -j "%OUTDIR%\jmeter.log" -e -o "%OUTDIR%\report"
echo.
echo ============================================================
