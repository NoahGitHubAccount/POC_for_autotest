...
| RT-業主 | 業主問題單複測（21 編號 23 筆） | 低-中 | 匯集待審 10 案 | `specs/integration/RT-業主 業主問題單複測.md` | `tests/integration/test_rt_業主問題單複測.py` | review：no214/215/216/208a/222b（5P）＋222a×3/223a×2（XF 維持） | 台帳 `整合測試_業主複測台帳.md`；B 群 10 筆待公民態；C 群 5 筆人工；205 待「不合規樣態」釐清 |

## 決議紀錄（最新在上）

- **2026-07-18 XXVIII** — **業主複測首日執行（A 群收工）＋IT-17 開跑＋ISS-020 開案**：
