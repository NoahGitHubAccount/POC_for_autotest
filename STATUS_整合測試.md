...
| RT-業主 | 業主問題單複測（21 編號 23 筆） | 低-中 | 匯集待審 18 案（12P/6XF） | `specs/integration/RT-業主 業主問題單複測.md` | `test_rt_業主問題單複測.py`＋`…_公民態.py` | review：A 群 no214/215/216/208a/222b（5P）＋222a×3/223a×2（XF 維持）；B 群 no199/201/202+212/208b/209/210/211（7P）＋no213（XF＝未修，系統忙碌 modal） | 台帳 `整合測試_業主複測台帳.md`；餘 218（credentialNote 探勘）、205（樣態待業主釐清）、C 群人工 5 筆＋207 改人工 |
